...
export class WizardController {
    ...
    renderPartnerView(partner) {
        ...
        const initialComment = escapeHtml(pf.general_comment || '');

        // Header (Freq, Comment, NPS)
        const headerHTML = `
            <h3>Bewertung: ${escapeHtml(partner.name)}</h3>
            <div class="partner-header" style="background:#fff; padding:20px; border-radius:8px; border:1px solid #ecf0f1; margin-bottom:30px;">
                <div class="form-row">
                    <div class="form-group">
                        <label>Wie häufig arbeitest Du mit ${escapeHtml(partner.name)} zusammen? *</label>
                ...
                <div class="form-row" style="margin-top:20px;">
                    <div class="form-group" style="width:100%;">
                        <label>Würdest Du ${escapeHtml(partner.name)} weiterempfehlen? (NPS) *</label>
        ...
        Object.entries(groupedCriteria).forEach(([groupName, criteria]) => {
            ...
            criteria.forEach((criterion) => {
                ...
                const escapedComment = escapeHtml(currentComment);
